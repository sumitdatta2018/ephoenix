...
public class LmsController {
	...
	private static Logger log = LoggerFactory.getLogger(LmsController.class);

	@Autowired
	private LmsService lmsService;

	@RequestMapping(value = "/master-data", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<?> fetchMasterData(@RequestParam String types) {
